            ...
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        {/* <p className='text-justify w-1/3'>Not everyone will be a professional player or play at the top level. But, what's wrong with continuing to practice your favorite sporting events? Age, profession, class, caste, religion, nothing can be a barrier. </p> */}
                    </a>
                </div>
